...
@Entity
public class Tbbasket extends AuditingFields {
    ...
    protected Tbbasket(){}
    private Tbbasket(String tbuserId, String title, Integer countread, Integer minParticipants, Integer maxParticipants, Integer femaleParticipants, Integer maleParticipants, String minSchoolNum, String maxSchoolNum, String place, LocalDate matchDate, LocalDateTime startTime, LocalDateTime endTime , String content) {
    ...
    public static Tbbasket of(String tbuserId, String title, Integer minParticipants, Integer maxParticipants, Integer femaleParticipants, Integer maleParticipants, String minSchoolNum, String maxSchoolNum, String place, LocalDate matchDate, LocalDateTime startTime, LocalDateTime endTime , String content) {
        return new Tbbasket(tbuserId, title, 0, minParticipants, maxParticipants, femaleParticipants, maleParticipants, minSchoolNum, maxSchoolNum, place, matchDate, startTime, endTime, content);
    }

    public TbbasketDto.CreateResDto toCreateResDto() {
        return TbbasketDto.CreateResDto.builder().id(this.getId()).build();
    }
}
