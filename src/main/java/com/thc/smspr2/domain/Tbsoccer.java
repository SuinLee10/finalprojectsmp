...
@Entity
public class Tbsoccer extends AuditingFields {
    ...
    protected Tbsoccer(){}
    private Tbsoccer(String tbuserId, String title, Integer countread, Integer minParticipants, Integer maxParticipants, Integer femaleParticipants, Integer maleParticipants, String minSchoolNum, String maxSchoolNum, String place, LocalDate matchDate, LocalDateTime startTime, LocalDateTime endTime , String content) {
    ...
    public static Tbsoccer of(String tbuserId, String title, Integer minParticipants, Integer maxParticipants, Integer femaleParticipants, Integer maleParticipants, String minSchoolNum, String maxSchoolNum, String place, LocalDate matchDate, LocalDateTime startTime, LocalDateTime endTime , String content) {
        return new Tbsoccer(tbuserId, title, 0, minParticipants, maxParticipants, femaleParticipants, maleParticipants, minSchoolNum, maxSchoolNum, place, matchDate, startTime, endTime, content);
    }

    public TbsoccerDto.CreateResDto toCreateResDto() {
        return TbsoccerDto.CreateResDto.builder().id(this.getId()).build();
    }
}
