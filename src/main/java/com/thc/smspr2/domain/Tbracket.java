...
@Entity
public class Tbracket extends AuditingFields {
    ...
    protected Tbracket(){}
    private Tbracket(String tbuserId, String title, Integer countread, Integer minParticipants, Integer maxParticipants, Integer femaleParticipants, Integer maleParticipants, String minSchoolNum, String maxSchoolNum, String place, LocalDate matchDate, LocalDateTime startTime, LocalDateTime endTime , String content) {
    ...
    public static Tbracket of(String tbuserId, String title, Integer minParticipants, Integer maxParticipants, Integer femaleParticipants, Integer maleParticipants, String minSchoolNum, String maxSchoolNum, String place, LocalDate matchDate, LocalDateTime startTime, LocalDateTime endTime , String content) {
        return new Tbracket(tbuserId, title, 0, minParticipants, maxParticipants, femaleParticipants, maleParticipants, minSchoolNum, maxSchoolNum, place, matchDate, startTime, endTime, content);
    }

    public TbracketDto.CreateResDto toCreateResDto() {
        return TbracketDto.CreateResDto.builder().id(this.getId()).build();
    }
}
