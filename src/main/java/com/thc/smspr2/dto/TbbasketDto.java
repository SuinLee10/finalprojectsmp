...
public class TbbasketDto {
    ...
    public static class CreateReqDto extends DefaultDto.BaseDto {
        ...
        @Schema(description = "tbbasketfileTypes", example="")
        private List<String> tbbasketfileTypes;
        @Schema(description = "tbbasketfileUrls", example="")
        private List<String> tbbasketfileUrls;
    }
    @SuperBuilder
    @Schema
    @Getter
    ...
    public static class CreateServDto extends CreateReqDto{
        ...
        public Tbbasket toEntity(){
            return Tbbasket.of(getTbuserId(), getTitle(), getMinParticipants(),getMaxParticipants(),getFemaleParticipants(),getMaleParticipants(),getMinSchoolNum(),getMaxSchoolNum(),getPlace(),getMatchDate(),getStartTime(),getEndTime(),getContent());
        }
    }
    @Builder
    @Schema
    ...
    public static class DetailResDto extends DefaultDto.DetailResDto{
        ...
        @Schema(description = "tbbasketfiles", example="")
        private List<TbbasketfileDto.DetailResDto> tbbasketfiles;
