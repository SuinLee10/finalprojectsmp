...
public class TbmatchDto {
    ...
    public static class CreateReqDto extends DefaultDto.BaseDto {
        ...
        @Schema(description = "tbmatchfileTypes", example="")
        private List<String> tbmatchfileTypes;
        @Schema(description = "tbmatchfileUrls", example="")
        private List<String> tbmatchfileUrls;
    }
    @SuperBuilder
    @Schema
    @Getter
    ...
    public static class CreateServDto extends CreateReqDto{
        ...
        public Tbmatch toEntity(){
            return Tbmatch.of(getTbuserId(), getTitle(), getMinParticipants(),getMaxParticipants(),getFemaleParticipants(),getMaleParticipants(),getMinSchoolNum(),getMaxSchoolNum(),getPlace(),getMatchDate(),getStartTime(),getEndTime(),getContent());
        }
    }
    @Builder
    @Schema
    ...
    public static class DetailResDto extends DefaultDto.DetailResDto{
        ...
        @Schema(description = "tbmatchfiles", example="")
        private List<TbmatchfileDto.DetailResDto> tbmatchfiles;
