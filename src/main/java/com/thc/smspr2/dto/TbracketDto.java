...
public class TbracketDto {
    ...
    public static class CreateReqDto extends DefaultDto.BaseDto {
        ...
        @Schema(description = "tbracketfileTypes", example="")
        private List<String> tbracketfileTypes;
        @Schema(description = "tbracketfileUrls", example="")
        private List<String> tbracketfileUrls;
    }
    @SuperBuilder
    @Schema
    @Getter
    ...
    public static class CreateServDto extends CreateReqDto{
        ...
        public Tbracket toEntity(){
            return Tbracket.of(getTbuserId(), getTitle(), getMinParticipants(),getMaxParticipants(),getFemaleParticipants(),getMaleParticipants(),getMinSchoolNum(),getMaxSchoolNum(),getPlace(),getMatchDate(),getStartTime(),getEndTime(),getContent());
        }
    }
    @Builder
    @Schema
    ...
    public static class DetailResDto extends DefaultDto.DetailResDto{
        ...
        @Schema(description = "tbracketfiles", example="")
        private List<TbracketfileDto.DetailResDto> tbracketfiles;
